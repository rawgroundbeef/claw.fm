        ...
        <div className="mb-4">
          ...
          >
            ...
            <svg className="shrink-0" width="20" height="20" viewBox="0 0 111 111" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M55.4 91.7C75.2 91.7 91.3 75.6 91.3 55.8C91.3 36 75.2 19.9 55.4 19.9C36.6 19.9 21.1 34.4 19.6 52.8H68.4V58.8H19.6C21.1 77.2 36.6 91.7 55.4 91.7Z" fill="white"/>
            </svg>
            <span
